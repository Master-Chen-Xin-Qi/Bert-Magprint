...
DATASET_PATH = r'D:\\pycharm\\Magprint\\dataset\\Activity recognition exp'
...
def preprocess_hhar(path, path_save, version, window_time=50, seq_len=40, jump=0):
    ...
    print('accs load finish!len: %d' %len(accs))
    gyros = pd.read_csv(path + '\Phones_gyroscope.csv') #, nrows=200000
    print('gyros load finish!len: %d' %len(gyros))
